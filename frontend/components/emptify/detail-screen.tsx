        ...
        <div className="flex flex-col gap-[var(--space-3)]">
          ...
          {email.informational ? (
            <div className="flex gap-[var(--space-2)] mt-[var(--space-3)] border-t border-[var(--color-divider)] pt-[var(--space-3)] flex-wrap">
              <button type="button" className="btn-emptify btn-emptify-secondary" onClick={onMarkRead}>
                Mark read
              </button>
              <button type="button" className="btn-emptify btn-emptify-secondary" onClick={onRemove}>
                Remove from Emptify
              </button>
              <button type="button" className="btn-emptify btn-emptify-secondary" onClick={onArchive}>
                Archive
              </button>
              <button type="button" className="btn-emptify btn-emptify-secondary" onClick={onDeleteClick}>
                Delete
              </button>
              <button type="button" className="btn-emptify btn-emptify-secondary" onClick={onUnsubscribe}>
                Unsubscribe
              </button>
            </div>
          ) : (
